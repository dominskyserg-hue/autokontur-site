...
export const CATEGORIES: CategoryDef[] = [
  ...
  },
  {
    ...
    // 'прокладок' окремо: родовий відмінок множини ("Комплект прокладок")
    // НЕ містить підрядка 'прокладк' (прокла-док), тож такі товари раніше
    // не потрапляли в жодну категорію
    matchGroups: [['прокладк', 'прокладок', 'кільц', 'кольц', 'поршнев']],
